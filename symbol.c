...
// [RH] end of Skull Tag functions
	...
	{ "listprocess", PCD_NOP, PCD_LISTPROCESS, 0, 0, 0, NO, NO },
	{ "countprocess", PCD_NOP, PCD_COUNTPROCESS, 0, 0, 0, YES, NO },
	{ "getpid", PCD_NOP, PCD_GETPID, 1, 0, 0, YES, NO },
	{ "getpname", PCD_NOP, PCD_GETPNAME, 1, 0, 0, YES, NO },
	{ "killprocess", PCD_NOP, PCD_KILLPROCESS, 1, 0, 0, NO, NO },
